...
@section('content')
    @include('layouts.partials.page-title', ['subtitle' => 'Apex', 'title' => 'Bar Chart'])
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div dir="ltr">
                        <div id="stacked-bar" class="apex-charts" data-colors="#727cf5,#0acf97,#fa5c7c,#6c757d,#39afd1">
                        </div>
                    </div>
                </div>
                <!-- end card body-->
                ...
                <div class="card-body">
                    ...
                    <div dir="ltr">
                        <div id="full-stacked-bar" class="apex-charts"
                            data-colors="#ffbc00,#39afd1,#6c757d,#e3eaef,#727cf5"></div>
                    </div>
                </div>
                <!-- end card body-->
            </div>
                ...
                <div class="card-body">
                    ...
                    <div dir="ltr">
                        <div id="datalables-bar" class="apex-charts"
                            data-colors="#727cf5,#0acf97,#fa5c7c,#6c757d,#39afd1,#2b908f,#ffbc00,#90ee7e,#f48024,#212730">
                        </div>
                    </div>
                </div>
                <!-- end card body-->
