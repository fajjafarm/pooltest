                ...
                <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item text-center active">
                            <img src="/images/products/p-3.png" alt="" class="img-fluid bg-body shadow-none rounded">
                        </div>
                        <div class="carousel-item text-center">
                            <img src="/images/products/p-9.png" alt="" class="img-fluid bg-body shadow-none rounded">
                        </div>
                        <div class="carousel-item text-center">
                            <img src="/images/products/p-10.png" alt="" class="img-fluid bg-body shadow-none rounded">
                        </div>
                        <div class="carousel-item text-center">
                            <img src="/images/products/p-11.png" alt="" class="img-fluid bg-body shadow-none rounded">
                        </div>
                        <div class="carousel-item text-center">
                            <img src="/images/products/p-12.png" alt="" class="img-fluid bg-body shadow-none rounded">
                        </div>
                    </div>
                    <div class="carousel-indicators m-0 mt-2 d-lg-flex d-none position-static h-100 rounded gap-1">
                        <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="0" aria-current="true" aria-label="Slide 1" class="h-auto rounded bg-light-subtle border active" style="width: auto !important;">
                            <img src="/images/products/p-3.png" class="d-block avatar-xl" alt="swiper-indicator-img">
                        </button>
                        <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="1" aria-label="Slide 2" class="h-auto rounded bg-light-subtle border" style="width: auto !important;">
                            <img src="/images/products/p-9.png" class="d-block avatar-xl" alt="swiper-indicator-img">
                        </button>
                        <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="2" aria-label="Slide 3" class="h-auto rounded bg-light-subtle border" style="width: auto !important;">
                            <img src="/images/products/p-10.png" class="d-block avatar-xl" alt="swiper-indicator-img">
                        </button>
                        <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="3" aria-label="Slide 4" class="h-auto rounded bg-light-subtle border" style="width: auto !important;">
                            <img src="/images/products/p-11.png" class="d-block avatar-xl" alt="swiper-indicator-img">
                        </button>
                        <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="4" aria-label="Slide 1" class="h-auto rounded bg-light-subtle border" style="width: auto !important;">
                            <img src="/images/products/p-12.png" class="d-block avatar-xl" alt="swiper-indicator-img">
                        </button>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-xl-6 col-lg-12">
                                <div class="pe-lg-3">
                                    ...
                                    <div class="d-flex flex-wrap align-items-center gap-2 text-center">
                                        <div>
                                            <a href="#!">
                                                <img src="/images/products/p-3.png" alt="" class="avatar-xl bg-light-subtle rounded border">
                                            </a>
                                        </div>
                                        <div>
                                            <a href="#!">
                                                <img src="/images/products/p-12.png" alt="" class="avatar-xl bg-light-subtle rounded border">
                                            </a>
                                        </div>
                                        <div>
                                            <a href="#!">
                                                <img src="/images/products/p-11.png" alt="" class="avatar-xl bg-light-subtle rounded border">
                                            </a>
                                        </div>
                                        <div>
                                            <a href="#!">
                                                <img src="/images/products/p-10.png" alt="" class="avatar-xl bg-light-subtle rounded border">
                                            </a>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="d-flex gap-3">
                                                <div>
                                                    ...
                                                    <a href="#!">
                                                        <img src="/images/products/p-10.png" alt="" class="avatar-xl bg-light-subtle rounded border d-none">
                                                    </a>
                                                </div>
                                                <div>
                            ...
                            <div class="col-xl-6 col-lg-12 border-start">
                                <div class="ps-lg-3">
                                    ...
                                    <div class="row mt-3 text-center g-2">
                                        <div class="col-lg-4">
                                            <img src="/images/products/p-3.png" alt="" class="img-fluid border rounded">
                                        ...
                                        <div class="col-lg-4">
                                            <img src="/images/products/p-9.png" alt="" class="img-fluid border rounded">
                                            <div class="d-flex align-items-center justify-content-center gap-2 mt-2 mb-1">
                                                <ul class="d-flex text-warning m-0 fs-18 list-unstyled">
                                                    <li>
                                                        <i class="ti ti-star-filled"></i>
                                        ...
                                        <div class="col-lg-4">
                                            <img src="/images/products/p-10.png" alt="" class="img-fluid border rounded">
                                            <div class="d-flex align-items-center justify-content-center gap-2 mt-2 mb-1">
                                                <ul class="d-flex text-warning m-0 fs-18 list-unstyled">
                                                    <li>
                                                        <i class="ti ti-star-filled"></i>
                                        ...
                                        <div class="col-lg-4">
                                            <img src="/images/products/p-11.png" alt="" class="img-fluid border rounded">
                                            <div class="d-flex align-items-center justify-content-center gap-2 mt-2 mb-1">
                                                <ul class="d-flex text-warning m-0 fs-18 list-unstyled">
                                                    <li>
                                                        <i class="ti ti-star-filled"></i>
                                        ...
                                        <div class="col-lg-4">
                                            <img src="/images/products/p-12.png" alt="" class="img-fluid border rounded">
                                            <div class="d-flex align-items-center justify-content-center gap-2 mt-2 mb-1">
                                                <ul class="d-flex text-warning m-0 fs-18 list-unstyled">
                                                    <li>
                                                        <i class="ti ti-star-filled"></i>
