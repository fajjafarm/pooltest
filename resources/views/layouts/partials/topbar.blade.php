                            ...
                            <div class="col-md-4">
                                <div class="p-3">
                                    ...
                                    <ul class="list-unstyled megamenu-list">
                                        ...
                                        <li>
                                            <a href="{{ route ('third' , ['components','extended-ui','dragula']) }}">Dragula</a>
                                        </li>
                                        <li>
                                            <a href="{{ route ('second' , ['ui','dropdowns']) }}">Dropdowns</a>
                                        </li>
                                        <li>
                                            <a href="{{ route ('third' , ['components','extended-ui','ratings']) }}">Ratings</a>
                                        </li>
                                        <li>
                                            <a href="{{ route ('third' , ['components','extended-ui','sweet-alerts']) }}">Sweet Alerts</a>
                                        </li>
                                        <li>
                                            <a href="{{ route ('third' , ['components','extended-ui','scrollbar']) }}">Scrollbar</a>
                                        </li>
                                        <li>
