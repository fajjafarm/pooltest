    ...
    <div class="row">
        <div class="col-xl-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use flexbox utilities, float utilities, or text alignment utilities to place
        ...
        <div class="col-xl-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>flexbox utilities</code>, <code>float utilities</code>, or <code>text
