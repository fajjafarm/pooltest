    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">You can use the <code>.link-*</code> classes to colorize links. Unlike the <a
                            href="{{ route ('second' , ['ui','utilities']) }}"><code>.text-*</code> classes</a>, these classes have a
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted"><a href="{{ route ('second' , ['ui','utilities']) }}">Colored link helpers</a> have been updated to pair
