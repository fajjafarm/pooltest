        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div dir="ltr">
                        <div id="multiple-radialbar" class="apex-charts" data-colors="#6c757d,#ffbc00,#727cf5,#0acf97">
                        </div>
                    </div>
                </div>
                <!-- end card body-->
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center" dir="ltr">
                        <div id="circle-angle-radial" class="apex-charts" data-colors="#0acf97,#727cf5,#fa5c7c,#ffbc00">
                        </div>
                    </div>
                </div>
                <!-- end card body-->
