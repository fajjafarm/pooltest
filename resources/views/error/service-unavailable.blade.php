...
<head>
    @include('layouts.partials.title-meta', ['title' => 'Error 503'])
            ...
            <div class="col-xl-4 col-lg-5 col-md-6">
                <div class="card overflow-hidden text-center h-100 p-xxl-4 p-3 mb-0">
                    ...
                    <div class="mx-auto text-center">
                        ...
                        <h5 class="fw-bold mt-2 text-dark lh-base">This Site Is Temporarily Down For Improvements.</h5>
                        <p class="text-muted fs-12 mb-3">The server is currently unable to handle the request due to
                            temporary overload or maintenance. Please try again later.</p>
