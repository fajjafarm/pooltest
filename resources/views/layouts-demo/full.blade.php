    ...
    <div class="row">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-md flex-shrink-0 me-2">
                                                        <span class="avatar-title bg-primary-subtle rounded-circle">
                                                            <img src="/images/products/logo/logo-1.svg"
                                                                alt="" height="22">
                                                        </span>
                                                    </div>
                                                    <div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-md flex-shrink-0 me-2">
                                                        <span class="avatar-title bg-info-subtle rounded-circle">
                                                            <img src="/images/products/logo/logo-4.svg"
                                                                alt="" height="22">
                                                        </span>
                                                    </div>
                                                    <div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-md flex-shrink-0 me-2">
                                                        <span class="avatar-title bg-secondary-subtle rounded-circle">
                                                            <img src="/images/products/logo/logo-5.svg"
                                                                alt="" height="22">
                                                        </span>
                                                    </div>
                                                    <div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-md flex-shrink-0 me-2">
                                                        <span class="avatar-title bg-danger-subtle rounded-circle">
                                                            <img src="/images/products/logo/logo-6.svg"
                                                                alt="" height="22">
                                                        </span>
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-md flex-shrink-0 me-2">
                                                        <span class="avatar-title bg-primary-subtle rounded-circle">
                                                            <img src="/images/products/logo/logo-8.svg"
                                                                alt="" height="22">
                                                        </span>
                                                    </div>
                                                    <div>
                                ...
                                <table class="table table-custom align-middle table-nowrap table-hover mb-0">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="avatar-lg">
                                                    <img src="/images/products/p-1.png" alt="Product-1"
                                                        class="img-fluid rounded-2">
                                                </div>
                                            </td>
                                            <td class="ps-0">
                                                <h5 class="fs-14 my-1"><a href="{{ route ('second' , ['ecommerce','product-details']) }}"
        ...
        <div class="col-auto info-sidebar">
            <div class="alert alert-primary d-flex align-items-center">
                <iconify-icon icon="solar:help-bold-duotone" class="fs-24 me-1"></iconify-icon> <b>Help line:</b> <span
                    class="fw-medium ms-1">+(012) 123 456 78</span>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center gap-2 position-relative mb-2">
                        ...
                        <div>
                            <h5 class="fs-14 my-1"><a href="{{ route ('second' , ['ecommerce','order-details']) }}"
                        ...
                        <div class="timeline-alt py-0">
                            <div class="timeline-item">
                                ...
                                <div class="timeline-item-info">
                                    <a href="javascript:void(0);" class="link-reset fw-semibold mb-1 d-block">You sold an
                                        item</a>
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-item-info">
                                    <a href="javascript:void(0);" class="link-reset fw-semibold mb-1 d-block">Product on
                                        the Theme Market</a>
