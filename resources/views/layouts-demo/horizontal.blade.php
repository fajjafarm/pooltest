                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md flex-shrink-0 me-2">
                                                    <span class="avatar-title bg-danger-subtle rounded-circle">
                                                        <img src="/images/products/logo/logo-6.svg" alt="" height="22">
                                                    </span>
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md flex-shrink-0 me-2">
                                                    <span class="avatar-title bg-primary-subtle rounded-circle">
                                                        <img src="/images/products/logo/logo-8.svg" alt="" height="22">
                                                    </span>
                                                </div>
                                                <div>
                            ...
                            <table class="table table-custom align-middle table-nowrap table-hover mb-0">
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="avatar-lg">
                                                <img src="/images/products/p-1.png" alt="Product-1" class="img-fluid rounded-2">
                                            </div>
                                        </td>
                                        <td class="ps-0">
                                            <h5 class="fs-14 my-1"><a href="{{ route ('second' , ['ecommerce','product-details']) }}" class="link-reset">ASOS High Waist Tshirt</a></h5>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="avatar-lg">
                                                <img src="/images/products/p-7.png" alt="Product-1" class="img-fluid rounded-2">
                                            </div>
                                        </td>
                                        <td class="ps-0">
                                            <h5 class="fs-14 my-1"><a href="{{ route ('second' , ['ecommerce','product-details']) }}" class="link-reset">Marco Single Sofa</a></h5>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="avatar-lg">
                                                <img src="/images/products/p-4.png" alt="Product-1" class="img-fluid rounded-2">
                                            </div>
                                        </td>
                                        <td class="ps-0">
                                            <h5 class="fs-14 my-1"><a href="{{ route ('second' , ['ecommerce','product-details']) }}" class="link-reset">Smart Headphone </a></h5>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="avatar-lg">
                                                <img src="/images/products/p-5.png" alt="Product-1" class="img-fluid rounded-2">
                                            </div>
                                        </td>
                                        <td class="ps-0">
                                            <h5 class="fs-14 my-1"><a href="{{ route ('second' , ['ecommerce','product-details']) }}" class="link-reset">Lightweight Jacket</a></h5>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="avatar-lg">
                                                <img src="/images/products/p-6.png" alt="Product-1" class="img-fluid rounded-2">
                                            </div>
                                        </td>
                                        <td class="ps-0">
                                            <h5 class="fs-14 my-1"><a href="{{ route ('second' , ['ecommerce','product-details']) }}" class="link-reset">Marco Shoes</a></h5>
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center gap-2 position-relative mb-2">
                    <div class="avatar-md flex-shrink-0">
                        <img src="/images/products/p-6.png" alt="product-pic" height="36">
                    </div>
                    <div>
                        <h5 class="fs-14 my-1"><a href="{{ route ('second' , ['ecommerce','order-details']) }}" class="stretched-link link-reset">Marco Shoes</a></h5>
                ...
                <div class="d-flex align-items-center gap-2 position-relative mb-2">
                    <div class="avatar-md flex-shrink-0">
                        <img src="/images/products/p-1.png" alt="product-pic" height="36">
                    </div>
                    <div>
                        <h5 class="fs-14 my-1"><a href="{{ route ('second' , ['ecommerce','order-details']) }}" class="stretched-link link-reset">High Waist Tshirt</a></h5>
                ...
                <div class="d-flex align-items-center gap-2 position-relative mb-2">
                    <div class="avatar-md flex-shrink-0">
                        <img src="/images/products/p-3.png" alt="product-pic" height="36">
                    </div>
                    <div>
                        <h5 class="fs-14 my-1"><a href="{{ route ('second' , ['ecommerce','order-details']) }}" class="stretched-link link-reset">Comfirt Chair</a></h5>
                ...
                <div class="d-flex align-items-center gap-2 position-relative mb-2">
                    <div class="avatar-md flex-shrink-0">
                        <img src="/images/products/p-4.png" alt="product-pic" height="36">
                    </div>
                    <div>
                        <h5 class="fs-14 my-1"><a href="{{ route ('second' , ['ecommerce','order-details']) }}" class="stretched-link link-reset">Smart Headphone</a></h5>
                ...
                <div class="d-flex align-items-center gap-2 position-relative">
                    <div class="avatar-md flex-shrink-0">
                        <img src="/images/products/p-2.png" alt="product-pic" height="36">
                    </div>
                    <div>
                        <h5 class="fs-14 my-1"><a href="{{ route ('second' , ['ecommerce','order-details']) }}" class="stretched-link link-reset">Laptop Bag</a></h5>
