                ...
                <div class="card-body">
                    <div class="row justify-content-between g-3">
                        <div class="col-xl-3 col-lg-6">
                            <div>
                                <div
                                    class="avatar-lg bg-primary rounded d-flex align-items-center justify-content-center mb-3">
                        ...
                        <div class="col-xl-5 col-lg-6 text-center">
                            <img src="/images/png/faq.png" alt="" class="img-fluid mt-3">
                                ...
                                <div class="border p-3 rounded bg-light-subtle">
                                    <form>
                                        <div class="mb-2">
                                            ...
                                            <input type="text" id="your-name" name="your-name" class="form-control"
                                                placeholder="Full Name">
                                        </div>
                                        <div class="mb-2">
                                            <label for="email-email" class="form-label">Email</label>
                                            <input type="email" id="email-email" name="email-email" class="form-control"
                                                placeholder="Email">
                                        </div>
                                        <div class="mb-2">
